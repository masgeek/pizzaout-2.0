...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=0;
        ...
        $this->addForeignKey('fk-access-tokens', 'access_tokens', 'user_id', 'user', 'id', 'CASCADE', 'CASCADE');
        $this->addForeignKey('fk-auth-code', 'authorization_codes', 'user_id', 'user', 'id', 'CASCADE', 'CASCADE');
    }
    ...
    public function safeDown()
    {
        ...
        $this->dropForeignKey('fk-access-tokens', 'access_tokens');
        $this->dropForeignKey('fk-auth-code', 'authorization_codes');
